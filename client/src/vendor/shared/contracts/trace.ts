...
export const PromptAssembly = z.object({
  ...
  /** Derived intent & scope section (untrusted, delimiter-wrapped); null when
      no intent was resolved for the run. */
...
export const RunStats = z.object({
  ...
  /** USD cost of the run; null = unknown (unpriced model / incomplete run), NOT 0. */
