...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // Deliberate exception to "vendor/ui is do-not-touch": no in-tree
      // upstream exists for this file, `ShellContext` has no nav extension
      // point, and `activeKeyFor` + the i18n key already anticipated this
      // entry. See specs/conventions.md → Consequences.
