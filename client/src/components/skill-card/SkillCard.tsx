/* SkillCard — name, type + source badges, description, enabled toggle.
   Mirrors AgentCard's shape (client/src/components/agent-card). */
"use client";
...
export function SkillCard({
  ...
  return (
    <div onClick={onClick} style={s.card(!!active, skill.enabled)}>
      ...
      <div style={s.description}>{skill.description || t("page.heading")}</div>
      <div style={s.metaRow}>
