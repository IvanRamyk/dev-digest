...
| `08-conventions` | `/conventions` → seeded scan header + accepted/pending/config candidates render |
| `09-pr-smart-diff` | PR #482 → Files changed tab → Smart Diff groups (Core logic → ratelimit.ts, Boilerplate → pnpm-lock.yaml) render |
