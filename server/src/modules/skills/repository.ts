...
/**
 * A1 — skills data-access. Owns `skills` + `skill_versions` only — the
 * `agent_skills` link table belongs to `modules/agents` (O7: the agent side owns
 * link/reorder/list-for-an-agent). Workspace-scoped throughout.
 */
...
export class SkillsRepository {
   ...
   * into skill_versions — this is what keeps eval runs reproducible against the
   * exact text they scored. A name/description/enabled-only edit does not bump.
   */
