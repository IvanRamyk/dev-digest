...
ALTER TABLE "conventions" ADD COLUMN "source" text DEFAULT 'model' NOT NULL;--> statement-breakpoint
...
ALTER TABLE "conventions" ADD COLUMN "verification" text DEFAULT 'unverified' NOT NULL;--> statement-breakpoint
ALTER TABLE "conventions" ADD COLUMN "support_count" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "conventions" ADD COLUMN "violation_count" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
